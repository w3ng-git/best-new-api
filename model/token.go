...
type Token struct {
	...
	ClaudeCacheTTL     string         `json:"claude_cache_ttl" gorm:"default:''"`
...
func (token *Token) Update() (err error) {
	...
	err = DB.Model(token).Select("name", "status", "expired_time", "remain_quota", "unlimited_quota",
		"model_limits_enabled", "model_limits", "allow_ips", "group", "cross_group_retry", "claude_cache_ttl").Updates(token).Error
	return err
}
