...
import AssignShardModal from './modals/AssignShardModal';
...
const UsersTable = (usersData) => {
  ...
  const [showUserSubscriptionsModal, setShowUserSubscriptionsModal] =
    useState(false);
  const [showAssignShardModal, setShowAssignShardModal] = useState(false);
  ...
  const showAssignShardUserModal = (user) => {
    setModalUser(user);
    setShowAssignShardModal(true);
  };
  ...
  const columns = useMemo(() => {
    return getUsersColumns({
      ...
      showAssignShardModal: showAssignShardUserModal,
    });
  }, [
    t,
    setEditingUser,
  ...
  return (
    <>
      ...
      />
      <AssignShardModal
        visible={showAssignShardModal}
        user={modalUser}
        onClose={() => setShowAssignShardModal(false)}
        onSuccess={() => {
          setShowAssignShardModal(false);
          refresh?.();
        }}
      />
    </>
